...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'ron':
				tex = Paths.getSparrowAtlas('characters/BRon', 'shared');
				frames = tex;
				animation.addByPrefix('idle', "Idle", 24);
				animation.addByPrefix('singUP', 'Sing Up', 24, false);
				animation.addByPrefix('singDOWN', 'Sign Down', 24, false);
				if (isPlayer)
				{
				...
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'Sing Right', 24, false);
					animation.addByPrefix('singRIGHT', 'Sing Left', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'Pico NOTE LEFT miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'Pico Note Right Miss', 24, false);
				}
			...
			case 'hellbob':
				...
				animation.addByPrefix('singUPmiss', 'bobismad', 24);
				animation.addByPrefix('singDOWNmiss', 'Pico Down Note MISS', 24);
